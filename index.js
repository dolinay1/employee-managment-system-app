...
// end database connection pn exit
...
// with the name of the department retrieve the id
...
// with the name of the role retrieve the id
...
// returns an array with only two elements in it: [first_name, last_name]

function getFirstAndLastName( fullName ) {
    // If a person has a space in their first name, such as "Mary Kate", then first_name needs to ignore that first space.
    // last names often do not have spaces in them so count the number of elements in the array after the split and merge all before the last element
...
async function updateEmployeeRole(employeeInfo) {
    ...
    // UPDATE employee SET role_id=1 WHERE employee.first_name='Mary Kate' AND employee.last_name='Smith';
...
async function addEmployee(employeeInfo) {
    ...
    // INSERT into employee (first_name, last_name, role_id, manager_id) VALUES ("John", "Smith", 8, 5);
...
async function removeEmployee(employeeInfo) {
    ...
    // DELETE from employee WHERE first_name="John" AND last_name="Smith";
